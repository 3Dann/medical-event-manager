...
NSCLC_TEMPLATE = {
    ...
    "steps": [
        ...
        },
        {
            ...
            "tasks": [
                "קבל אישור Exploration Gate (force-gate אם נדרש)",
                "תאם הוספיס בית דרך קופת חולים",
                "הפגש עם משפחה לשיחת תכנון",
                "תאם רפואה פליאטיבית + ניהול כאב",
                "וודא תיעוד כתב ויתור מודע",
            ],
        },
    ],
}

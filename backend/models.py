...
class PendingRegistration(Base):
    ...
    id_number         = Column(EncryptedText, nullable=True)   # ת"ז — encrypted PHI
    phone             = Column(EncryptedText, nullable=True)   # טלפון — encrypted PHI
...
class Doctor(Base):
    ...
    license_number = Column(String, nullable=True, unique=True)   # מספר רישיון משרד הבריאות

...
_ROUTES = [
    ...
    ("POST",   r"^/api/patients/\d+/medications$",                   "add_medication",    "medication", None),
    ("PUT",    r"^/api/patients/\d+/medications/(\d+)$",             "update_medication", "medication", 1),
    ("DELETE", r"^/api/patients/\d+/medications/(\d+)$",             "delete_medication", "medication", 1),

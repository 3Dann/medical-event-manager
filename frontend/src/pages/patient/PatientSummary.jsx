  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mb-4">
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-blue-600 hover:text-blue-800 text-base font-medium min-h-[44px] px-2"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const HELP_TEXT = {
  ...
  documents: 'כאן שמורים כל המסמכים הרפואיים והביטוחיים שלך. תוכל לצפות בהם, להורידם, ולהעלות מסמכים חדשים — בגרירה או בחירה.',

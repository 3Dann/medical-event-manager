...
export default function PatientDetail() {
  ...
  return (
    ...
    <div className="p-4 md:p-6">
      ...
      {/* Tabs — sticky */}
      <div className="sticky top-0 z-20 -mx-4 md:-mx-6 px-4 md:px-6 bg-slate-50 border-b border-slate-200 mb-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[88vh] flex flex-col" dir="rtl">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 flex-shrink-0">
            ...
            <button onClick={() => { setShowJourneyModal(false); setSelectedTplPreview(null) }}
              className="text-slate-400 hover:text-slate-600 text-xl w-8 h-8 flex items-center justify-center rounded-lg hover:bg-slate-100">✕</button>
          </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[10px] text-slate-400 mt-0.5">{tpl.nodes.length} צמתים</p>
                          </div>
                        </button>
                      )
                    })}

    ...
    <div className="flex h-screen bg-slate-50">
      ...
      <main className="flex-1 overflow-auto relative flex flex-col">
        ...
        <div className="sticky top-0 z-20 bg-white border-b border-slate-200 px-6 py-2.5 flex items-center gap-3">
          ...
          <Link to="/" className="mr-auto flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-lg text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-colors">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
